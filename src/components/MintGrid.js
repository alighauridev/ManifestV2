...
const MintGrid = () => {
    ...
    const calculateTimeLeft = () => {
        const difference = new Date('2023-07-02') - new Date();
        let timeLeft = {};
                            ...
                            <div>
                                <div className="topper">
                                    ...
                                    <div class="para" style={{
                                        ...
                                        margin: '8px 0 10px',
                                        textAlign: 'center'
                                    }}>BUY IN BEFORE PRICE INCREASES!</div>
                                    <div className="line">
                                ...
                                <div class="bal">
                                    <p>{selectedOptionTop?.label} Balance: {!account && 'Wallet not connected'}
